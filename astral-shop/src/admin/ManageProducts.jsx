...
import { FaTrash, FaEdit, FaPlus, FaChartLine, FaBoxOpen, FaShoppingCart, FaUsers, FaFileAlt } from "react-icons/fa";
    ...
    return (
        <div style={{ display: 'flex', minHeight: 'calc(100vh - 80px)', background: '#f8fafc' }}>
            ...
            <div style={{
                ...
                <Link to="/admin/products" style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '12px', background: 'var(--secondary)', color: 'var(--primary)', borderRadius: '8px', textDecoration: 'none', fontWeight: '600' }}>
                    <FaBoxOpen /> Products
                </Link>
            ...
            <div style={{ flex: 1, padding: '2rem 3rem' }}>
                <div className="flex-between" style={{ marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '2rem', color: 'var(--text-main)' }}>Manage Products</h1>
                    <button onClick={() => {
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '800px' }}>
                            ...
                            <tbody>
                                {products.length === 0 ? (
                                    ...
                                    <tr key={product.id} style={{ borderBottom: index !== products.length - 1 ? '1px solid #f1f5f9' : 'none', transition: 'background 0.2s' }} onMouseEnter={e => e.currentTarget.style.background = '#fcfcfc'} onMouseLeave={e => e.currentTarget.style.background = 'white'}>
